...
/* Next increment value for macro is 6 */
#define XMA_APP_EOF 6

#define BUFFER_ALLOC_ALIGN 4096
...
#define AV1_CODEC_TYPE 4
#define AV1_CODEC_NAME "av1_ama"

#define H265_CODEC_TYPE 2
#define HEVC_CODEC_TYPE H265_CODEC_TYPE
#define H265_CODEC_NAME "hevc_ama"
#define HEVC_CODEC_NAME H265_CODEC_NAME

#define H264_CODEC_TYPE 1
#define AVC_CODEC_TYPE H264_CODEC_TYPE
#define H264_CODEC_NAME "h264_ama"
...
typedef enum { BITS_PER_PIXEL_8 = 8, BITS_PER_PIXEL_10 = 10 } XlnxBitsPerPixel;
...
extern XlnxParameterLookup param_log_level_lookup[];

extern XlnxParameterLookup param_log_location_lookup[];

#define PARAM_LOG_LEVEL_KEYS 8
#define PARAM_LOG_LOCATION_KEYS 4
