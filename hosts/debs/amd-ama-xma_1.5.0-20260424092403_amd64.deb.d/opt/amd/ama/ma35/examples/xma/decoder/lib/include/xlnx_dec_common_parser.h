...
int xlnx_dec_find_next_start_code(XmaLogHandle log, int file, XlnxDecBuffer* buffer, int offset, bool is_first_au, int* retoffset);

int xlnx_dec_convert_to_rbsp(XmaLogHandle log, XlnxDecBuffer* buffer, int startoffset, int endoffset, XlnxDecBuffer* newbuffer);
