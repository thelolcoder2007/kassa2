...
enum AVFrameSideDataType {
...
#if CONFIG_VPE
    /**
     * Closed Caption metadata associated with a video frame.
     * The payload is an AVClosedCaption type and contains information for
     * ATSC A53 Part 4 Closed Captions standard.
     */
    AV_FRAME_DATA_CLOSED_CAPTION,

    /**
     * HDR dynamic metadata associated with a video frame. The payload is
     * an AVDynamicDolbyVision type and contains information for color
     * volume transform - application 1 of SMPTE 2094-10:2016 standard.
     */
    AV_FRAME_DATA_DYNAMIC_DOLBY_VISION,

    /**
     * HDR dynamic metadata associated with a video frame. The payload is
     * an AVDolbyVisionRpu type.
     */
    AV_FRAME_DATA_DOLBY_VISION_RPU,

    /**
     * Raw T35 data of SEI.
     */
    AV_FRAME_DATA_RAW_T35,

    /**
     * Raw Rpu data of DOVI.
     */
    AV_FRAME_DATA_RAW_RPU,
#endif
    /**
     ...
     */
    AV_FRAME_DATA_VUI_PARAMS,

    /**
     * AMA Sideband data type.
    */
    AV_FRAME_DATA_SB_ML_ROI,
    AV_FRAME_DATA_SB_ML_CC,
    AV_FRAME_DATA_SB_ML_CXC,
    AV_FRAME_DATA_SB_ML_LA_STAT,
    AV_FRAME_DATA_SB_ML_BOUNDING_BOX,
    AV_FRAME_DATA_SB_ML_CLASSIFICATION,
    AV_FRAME_DATA_SB_ML_YDATA,
    AV_FRAME_DATA_SB_ML_TENSOR,
#endif
};
...
#if CONFIG_VPE
/**
 * A flag to mark the frames which used by vpe decoder and should be discarded.
 */
#define AV_FRAME_FLAG_VPE_DISCARD   (1 << 5)

/**
 * A flag to mark the frames which used by vpe decoder and resolution is lower than before.
 */
#define AV_FRAME_FLAG_VPE_RESOLUTION_LOWER   (1 << 6)

/**
 * A flag to mark the frames which used by vpe decoder and resolution is higher than before.
 */
#define AV_FRAME_FLAG_VPE_RESOLUTION_HIGHER   (1 << 7)

/**
 * A flag to mark the frames which used by vpe decoder and resolution is exceed than max res.
 */
#define AV_FRAME_FLAG_VPE_RESOLUTION_EXCEED_INIT   (1 << 8)
#endif
/**
